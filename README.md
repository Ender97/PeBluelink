...
An open source Pebble watch app that acts as a remote to interact with Hyundai Bluelink compatible vehicles. Needs the Android companion app to function, requires a Bluelink subscription, and is only confirmed to work in the USA. Canada and Europe regions are currently in BETA and are not guaranteed to work. 
